...
var TodoList = Backbone.Collection.extend({
	...
	//Referefence to this collection's model
	model: app.Todo,
	...
	//Filter down the list to only todo items that are finished.
	completed: function(){
	...
	//We kep the Todos in sequential order, despite being saved by unordered 
